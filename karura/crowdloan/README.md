...
KSM holders lock their tokens on Kusama for a period of time \(6, 12 or 24 months\) to help Karura lease a parachain slot and gain access to Kusama’s plug-and-play security. In return for KSM holders’ loan, KAR \(Karura’s native token\) will be distributed to participants.
...
Please review our guides on creating a compatible wallet here. If you are already staking, please begin to unbond your KSM with these guides. 
...
[**Unstaking your KSM Tokens on Polkawallet** ](http://wiki.acala.network/unstake-polkawallet) ****
...
For additional information, please see the following FAQ.
