...
1. If you already have a Substrate address \(Polkadot address, Acala address or other\), we will show you [how to check the corresponding KSM address](karura/from-exisitng-wallet.md) and vice-versa.
2. If you don't have any account set up, we will show you how to [create a KSM account](karura/create-new-wallet.md), which can also be used for Polkadot, Acala and else.
